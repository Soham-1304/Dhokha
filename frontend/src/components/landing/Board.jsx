...
export default function Board() {
  ...
  return (
    <div className="board-wrap" ref={boardWrapRef}>
      ...
      <div className="card c1" ref={el => cardsRef.current[0] = el}>
      ...
      <div className="card c2" ref={el => cardsRef.current[1] = el}>
        <div className="pin"></div>
      ...
      <div className="card c3" ref={el => cardsRef.current[2] = el}>
        <div className="pin"></div>
      ...
      <div className="card flagged c-center" ref={el => cardsRef.current[3] = el}>
        <div className="pin"></div>
